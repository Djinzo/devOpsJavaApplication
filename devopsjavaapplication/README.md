...
```
cd existing_repo
git remote add origin http://localhost/root/devopsjavaapplication.git
git branch -M main
...
- [ ] [Set up project integrations](http://localhost/root/devopsjavaapplication/-/settings/integrations)
